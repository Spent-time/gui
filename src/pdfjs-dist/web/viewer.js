...
var PDFFindController = (function PDFFindControllerClosure() {
    ...
    PDFFindController.prototype = {
         ...
         */
        updateMatchPosition: function PDFFindController_updateMatchPosition(pageIndex, index, elements, beginIdx, endIdx) {
...
var PDFViewerApplication = {
    ...
    open: function pdfViewOpen(file, args) {
        ...
        // @martijn here we load the pdf
        var loadingTask = PDFJS.getDocument(array);
