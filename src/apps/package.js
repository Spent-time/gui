...
/**
 * <p>
 * his file is referenced by the `dojoBuild` key in `package.json` and provides extra hinting specific to the Dojo
...
var profile = {
    ...
    resourceTags: {
        ...
        copyOnly: function (filename, mid) {
            return (/^apps\/resources\//.test(mid) && !/\.css$/.test(filename));
        },
